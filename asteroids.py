...
class AsteroidsGame:
    ...
    def __init__(self, display: pygame.Surface):
        ...
        # Minimum distance from ship for asteroids to spawn (in pixels)
        self.MIN_SPAWN_DIST = 50 
        # Time in seconds to advance to the next level
    ...
    def level_1(self) -> str:
        ...
        return 'death_screen' if self.hit_asteroid else next_level
